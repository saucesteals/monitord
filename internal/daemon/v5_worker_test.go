...
func TestV5WorkerHandshakeTransactionAndACK(t *testing.T) {
	dir := t.TempDir()
	...
	w, err := startV5Worker(ctx, slog.Default(), runtime, g, nil)
	if err != nil {
		t.Fatal(err)
	}
